...
class HeadPoseEnrollment:
    def __init__(self, save_path='data/known_faces/new_person', yaw_threshold=5.0, pitch_threshold=5.0):
        ...
        self.enrollment_steps = [
            ...
            {"name": "UP", "angle_range": {"x": (8, 20), "y": (-10, 10)}, "duration": 2},
    ...
    def _save_image_compatibility(self, image, stage):
        """Save image for backward compatibility with registration app"""
        from datetime import datetime
        
        # For now, save the full frame - could be improved to crop face
